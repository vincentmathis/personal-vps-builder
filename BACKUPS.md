...
[](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-1---installation)
--------------------------------------------------------------------------------------------------
...
[](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-2---workflow-with-borg)
--------------------------------------------------------------------------------------------------------

Step 2 - Workflow with Borg
---------------------------

### [](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-21---activate-borg-and-configure-your-storage-box)
...
### [](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-22---initialize-borg-repository)
...
### [](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-23---create-first-backup)
...
### [](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-24---following-incremental-backups)
...
### [](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-26---automate-backups-with-cron)
...
[](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-3---hints)
-------------------------------------------------------------------------------------------

Step 3 - Hints
--------------

### [](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-31---full-system-backup)
...
### [](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-32---deduplication-and-reliability)
...
### [](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-33---borg-version-on-the-server)
...
### [](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-34---borg-and-ssh)

### Step 3.4 - Borg and SSH

BorgBackup uses SSH over port 23. SSH access is limited to Borg and login is not possible!

### [](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-35---use-borg-and-sftp--scp-in-parallel-with-keyfile)
...
### [](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#step-36---borg-keyfile-and-password)
...
[](https://community.hetzner.com/tutorials/install-and-configure-borgbackup#conclusion)
---------------------------------------------------------------------------------------
